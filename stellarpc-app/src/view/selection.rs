...
pub fn draw_selection<B>(f: &mut Frame<B>, area: Rect, controller: &mut Controller, block: Block)
where
    B: Backend,
{
...
/// Draws the help tile
pub fn draw_help2<B>(f: &mut Frame<B>, area: Rect, controller: &mut Controller, _block: Block)
where
    B: Backend,
{
